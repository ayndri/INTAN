/******/ (function () {
  ...
  /*!*************************************************!*\
  !*** ./resources/js/brand-management.js ***!
  \*************************************************/
  /**
   * Page Brand List
   */
  ...
  $(document).on('input', '#add-brand-name', function () {
  ...
  $(function () {
    ...
    var dt_user_table = $('.datatables-brands'),
      select2 = $('.select2'),
    ...
    if (dt_user_table.length) {
      var dt_user = dt_user_table.DataTable({
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function render(data, type, full, meta) {
              ...
              return '<span class="user-email">' + $brand_name + '</span>';
            }
          },
          {
            targets: 3,
            ...
            render: function render(data, type, full, meta) {
              return (
                ...
                '<button class="btn btn-sm btn-icon edit-record" data-id="'.concat(
                  full['id'],
                  '" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddBrand"><i class="ti ti-edit"></i></button>'
                ) +
        ...
        buttons: [
          ...
          {
            text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Brand</span>',
    ...
    $(document).on('click', '.delete-record', function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          $.ajax({
            type: 'GET',
            url: ''.concat(baseUrl, 'brands/').concat(brand_id, '/delete'),
    ...
    $(document).on('click', '.edit-record', function () {
      ...
      $('#offcanvasAddBrandLabel').html('Edit Brand');
