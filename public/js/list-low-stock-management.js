/******/ (function () {
  ...
  $(function () {
    ...
    if (dt_user_table.length) {
      let tableUrl = baseUrl + 'product/list-low-stock';

      // Event listener for Low Stock button
      $('#lowStockBtn').on('click', function () {
        tableUrl = baseUrl + 'product/list-low-stock'; // Update URL for Low Stock
        dt_user.ajax.url(tableUrl).load(); // Reload DataTable with new URL
        $(this).removeClass('btn-secondary').addClass('btn-warning');
        $('#outOfStockBtn').removeClass('btn-warning').addClass('btn-secondary');
      });

      // Event listener for Out of Stock button
      $('#outOfStockBtn').on('click', function () {
        tableUrl = baseUrl + 'product/list-out-stock'; // Update URL for Out of Stock
        dt_user.ajax.url(tableUrl).load(); // Reload DataTable with new URL
        $(this).removeClass('btn-secondary').addClass('btn-warning');
        $('#lowStockBtn').removeClass('btn-warning').addClass('btn-secondary');
      });
