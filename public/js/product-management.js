/******/ (function () {
  ...
  function formatRupiah(value) {
    ...
    let rupiah = split[0].replace(/\B(?=(\d{3})+(?!\d))/g, '.'); // Add thousand separators
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function render(data, type, full, meta) {
              ...
              var formattedPrice = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(
                $price
              );
          ...
          },
          {
            ...
            render: function render(data, type, full, meta) {
              var $cost = full['cost'];
              var formattedPrice = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format($cost);
              return '<span class="user-email">' + formattedPrice + '</span>';
            }
          },
          {
