...
<script src="{{asset('js/create-product-management.js')}}"></script>
@endsection
          ...
          <div class="accordion-body">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" id="add-product-name" class="form-control" placeholder="John Doe" />
              </div>
              <div class="col-md-6 align-items-end">
                <label class="form-label" for="add-product-sku">SKU</label>
                <div class="input-group">
                  <input type="text" id="add-product-sku" class="form-control" placeholder="Enter SKU">
              ...
              <div class="col-md-6">
                ...
                <select name="unit_id" id="add-product-unit" class="form-control">
                  ...
                  @foreach ($unit as $b)
                  <option value="{{ $b->id }}">{{ $b->unit_name }} ({{$b->short_name}})</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-6 align-items-end">
                ...
                <div class="input-group">
                  <input type="text" id="add-product-item-code" class="form-control" placeholder="Enter Item Code">
              ...
              <div class="col-12">
                ...
                <textarea name="description-textarea" class="form-control" id="add-product-description" rows="2" placeholder="Enter description"></textarea>
                  ...
                  <div class="flex-fill">
                    <div class="form-check custom-option custom-option-basic">
                      <label class="form-check-label custom-option-content" for="add-product-single">
                        <input name="productType" class="form-check-input" type="radio" value="single" id="add-product-single" checked onclick="showSection('single')" />
                  ...
                  <div class="flex-fill">
                    <div class="form-check custom-option custom-option-basic">
                      <label class="form-check-label custom-option-content" for="add-product-variable">
                        <input name="productType" class="form-check-input" type="radio" value="variable" id="add-product-variable" onclick="showSection('variable')" />
                        <span class="custom-option-header">
              ...
              <div id="singleProductSection" class="mt-3">
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="number" id="add-product-quantity" class="form-control" placeholder="Enter quantity" min="0" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="add-product-price">Price</label>
                    <input type="number" id="add-product-price" class="form-control" placeholder="Enter price" min="0" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="add-product-quantity-alert">Quantity Alert</label>
                    <input type="number" id="add-product-quantity-alert" class="form-control" placeholder="Enter quantity alert" min="0" />
                  </div>
                </div>
              </div>
