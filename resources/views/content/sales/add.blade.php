...
@section('page-script')
<script src="{{asset('js/sale/form-management.js')}}"></script>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Sale /</span> Insert
</h4>
<div class="row">
  <!-- FormValidation -->
  <div class="col-12">
        ...
        <form id="formValidationExamples" class="row g-3" method="POST" action="{{ route('sales.store') }}">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="saleDate" name="sale_date" class="form-control" value="{{ date('Y-m-d') }}" required>
            </div>
