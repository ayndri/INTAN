...
Route::get('/auth/forgot-password', [ForgotPasswordCover::class, 'index'])->name('forgot-password')->middleware('checkLogin');;
Route::post('/logout', [LoginCover::class, 'logout'])->name('logout');
Route::get('/', [LoginCover::class, 'index'])->name('auth-login-cover')->middleware('checkLogin');
Route::post('/', [LoginCover::class, 'login'])->name('login-post');
...
Route::middleware(['auth'])->group(function () {
  ...
  Route::group(['prefix' => 'purchases', 'as' => 'purchases.'], function () {
    ...
    Route::get('/list', [PurchasesController::class, 'list'])->name('list');
    Route::get('/suppliers/{id_supplier?}', [PurchasesController::class, 'listSupplier'])->name('suppliers.list');
  ...
  Route::get('/layouts/horizontal', $controller_path . '\layouts\Horizontal@index')->name('layout-horizontal-analytics');
  Route::get('/layouts/vertical', $controller_path . '\layouts\Vertical@index')->name('layout-vertical-analytics');
